...
KATMAI_NONSENSE_VCF = '/usr/local/somaticwrapper/demo/vep_annotate/data/nonsense.grch38.vcf'
KATMAI_CACHE_GZ = '/usr/local/somaticwrapper/demo/vep_annotate/data/katmai/cache/vep-cache.90_GRCh38.tar.gz'
KATMAI_CACHE_VERSION = '90'
KATMAI_REFERENCE_FASTA = '/usr/local/somaticwrapper/demo/vep_annotate/data/katmai/reference/GRCh38.d1.vd1.fa'
