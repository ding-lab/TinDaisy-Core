...
echo $MAIN_FILTER --local-script $FILTER_LOCAL $VCF vaf $CONFIG $XARGS
...
MUTECT_VCF="test_data/misc/mutect_result.filtered.vcf "
STRELKA_VCF="test_data/StrelkaDemo-results/strelka/filter_out/strelka.somatic.snv.all.dbsnp_pass.vcf"
VARSCAN_VCF="test_data/StrelkaDemo-results/varscan/filter_out/varscan.out.som_snv.Somatic.hc.somfilter_pass.dbsnp_pass.vcf"
VARSCAN_INDEL_VCF="test_data/StrelkaDemo-results/varscan/filter_out/varscan.out.som_indel.Somatic.hc.dbsnp_pass.vcf"
PINDEL_VCF="test_data/StrelkaDemo-results/pindel/filter_out/pindel.out.current_final.dbsnp_pass.vcf"
