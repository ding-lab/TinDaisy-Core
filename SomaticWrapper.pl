...
run_pindel:
    ...
    --num_parallel_pindel n: number of chromosomes to process at a time.  Default 4
parse_varscan_snv:
...
if (($step_number eq '1') || ($step_number eq 'run_strelka')) {
    ...
    die("normal_bam undefined \n") unless $normal_bam;
    die("reference_fasta undefined \n") unless $reference_fasta;
    run_pindel($tumor_bam, $normal_bam, $results_dir, $job_files_dir, $reference_fasta, $centromere_bed, $no_delete_temp, $chrlist, $num_parallel_pindel);
